...
t1 = train('TelanganaExpress',161235,'12:34','22:12','kzp','hyd','Mon',30,23,43,2205,320,234)
t2 = train('DelhiExpress',13119,'02:34','13:12','DNR','KLP','Mon',12,4,12,3234,235,134)
t3 = train('GaribRath',22353,'11:56','03:12','ctc','ban','Fri',33,24,77,455,325,533)
t4 = train('KonarkExpress',11020,'15:25','18:30','19:59','VZM','RJY',21,15,200,2500,1900,450)
...
u1 = user(5703,'lavanya','TelanaganaExpress','1612355703457','dibyadas')
u2= user(7700)
